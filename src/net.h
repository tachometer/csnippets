...
/**
 * set_nonblock - mark fd as a non-blocking fd.
 * @fd: file descriptor created usually by socket() or open() ...
 * @nonblock: whether it should really be nonblocking or blocking.
 * 
 * Example:
 *      int fd;
 *      ...
